...
class History(models.Model):
    ...
    image = models.BinaryField(null=True, blank=True, help_text='The image from door device')
    time = models.DateTimeField(auto_now_add=True)

    class Meta:
        ordering = ['time']
    def __str__(self):
        return f'{self.incident_id} ({self.door_id})'
...
class Face(models.Model):
    ...
    user_id = models.ForeignKey('User', on_delete=models.SET_NULL, null=True)
    image = models.BinaryField(null=True, blank=True, help_text='Image of user face')
